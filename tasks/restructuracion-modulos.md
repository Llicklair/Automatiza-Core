...
| 4 | 🟠 high | **OAuth Twitter/LinkedIn**: fallo de perfil → cuentas `'unknown'` + duplicados | `routes/marketing.py:312-340`: traga la excepción, guarda `account_id='unknown'` | `_fetch_profile` valida status y propaga; no persistir cuentas `unknown` |
