...
if celery_app is not None:
    ...
    def celery_execute_orchestrator(self, task_id: str) -> None:
        ...
        try:
            asyncio.run(execute_orchestrator(task_id))
