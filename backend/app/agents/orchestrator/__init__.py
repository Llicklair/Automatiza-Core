...
La lógica compartida (formateo de summaries, persistencia de documentos IA,
PendingApproval, auditoría/broadcast) vive en `services/orchestration/`.

Solo se re-exportan los símbolos consumidos desde fuera del paquete. Los
detalles internos (nodos del grafo, dispatchers) se importan directamente
desde sus submódulos cuando hace falta.
