...
def build_system_prompt(mode_note: str, tenant_id: str) -> str:
    return (
        ...
        "3. `send_email`: Envía un correo. FLUJO OBLIGATORIO: primero llama con confirm=False "
        "para mostrar el borrador al usuario y esperar su aprobación. Solo cuando el usuario "
        "confirme explícitamente ('sí, envía', 'adelante', etc.) llama de nuevo con confirm=True. "
        "Acepta `provider` para elegir desde qué cuenta enviar. "
