...
def build_casillas_111(data: dict) -> list[Casilla]:
    ...
    return [
        ...
        _c("02", c02),
        _c("03", c03),
        _c("07", c07, editable=True, formato="numero",
            nota="Perceptores de actividades económicas (profesionales) con retención en sus facturas."),
        _c("08", c08, editable=True,
            nota="Importe de las percepciones de actividades económicas."),
        _c("09", c09, editable=True,
            nota="Retenciones de actividades económicas (entran en la casilla 28)."),
        _c("28", c28),
