...
def generate_albaran_pdf(albaran_data: dict, theme_config: dict | None = None) -> bytes:
    ...
    title_sty  = ParagraphStyle("A_title",  parent=styles["Normal"], fontSize=20, fontName=bold,  textColor=colors.HexColor("#1e293b"))
    header_sty = ParagraphStyle("A_header", parent=styles["Normal"], fontSize=9,  fontName=bold,  textColor=colors.HexColor("#64748b"))
    body_sty   = ParagraphStyle("A_body",   parent=styles["Normal"], fontSize=9,  fontName=font,  textColor=colors.HexColor("#1e293b"))
    right_sty  = ParagraphStyle("A_right",  parent=styles["Normal"], fontSize=9,  fontName=font,  textColor=colors.HexColor("#1e293b"), alignment=TA_RIGHT)
    total_sty  = ParagraphStyle("A_total",  parent=styles["Normal"], fontSize=14, fontName=bold,  textColor=colors.HexColor(acc), alignment=TA_RIGHT)
    ...
    inv_block = [
        Spacer(1, 4),
        Paragraph("ALBARÁN", ParagraphStyle("A_ftitle", parent=styles["Normal"],
    ...
    if client_name:
        ...
        elements.append(Paragraph(client_name, ParagraphStyle("A_cname",
    ...
    totals_data = [
        ...
        [Paragraph("TOTAL:", ParagraphStyle("A_tlbl", parent=styles["Normal"],
    ...
    elements.append(Paragraph(footer_text, ParagraphStyle("A_foot",
