    ...
    return (
        <div className="rounded-xl border border-[#27272a] bg-[#111113] overflow-hidden flex flex-col shadow-lg">
            <div className="px-6 py-4 border-b border-[#27272a] flex items-center gap-3">
                ...
                <h2 className="text-sm font-semibold text-white">Busqueda Universal & Consultas IA</h2>
            </div>

            <div className="p-6">
                {chatMessages.length === 0 ? (
                    <div className="text-center py-4">
                        <p className="text-sm text-zinc-400">Encuentra cualquier archivo o pregunta detalles tecnicos a tus documentos.</p>
