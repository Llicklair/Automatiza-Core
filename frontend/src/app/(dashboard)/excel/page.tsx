...
import { FileSpreadsheet, Upload, Loader2, AlertCircle, CheckCircle2, Download, Trash2 } from "lucide-react";
        ...
        <div className="max-w-4xl mx-auto px-4 py-8 space-y-6">
            ...
            <div>
                <h1 className="text-xl font-semibold text-foreground flex items-center gap-2">
                    <FileSpreadsheet className="w-6 h-6 text-violet-400" /> Excel / Importación
                </h1>
                <p className="text-xs text-muted-foreground mt-1">Importa hojas de cálculo para que los agentes IA puedan analizarlas</p>
            </div>
