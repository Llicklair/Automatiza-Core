        ...
        <div className="p-8 max-w-6xl mx-auto space-y-8">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="mt-1 text-sm text-zinc-400">Gestiona el directorio de proveedores y sus datos de contacto.</p>
                </div>
                <button
                    onClick={openNew}
            ...
            <div className="grid grid-cols-3 gap-4">
                {[
                    { label: "Total proveedores", value: suppliers.length, color: "text-white" },
                    { label: "Con email", value: suppliers.filter(s => s.email).length, color: "text-indigo-400" },
            ...
            {loading ? (
                ...
                <div className="bg-[#111113] border border-[#27272a] rounded-2xl p-16 flex flex-col items-center text-center">
                    <Truck className="w-12 h-12 text-zinc-700 mb-4" />
                ...
                <div className="bg-[#111113] border border-[#27272a] rounded-2xl overflow-hidden">
                    ...
                    {filtered.map(s => (
                        <div key={s.id} className="grid grid-cols-12 gap-4 px-6 py-3.5 border-b border-[#27272a]/50 last:border-0 hover:bg-white/[0.02] transition-colors items-center">
                            ...
                            <div className="col-span-2">
                                <span className="text-sm text-zinc-400 font-mono">{s.nif || <span className="text-zinc-600 italic">—</span>}</span>
                            </div>
                            ...
                            <div className="col-span-2">
                                {s.city ? (
                                    <span className="text-sm text-zinc-400 flex items-center gap-1">
                                        <MapPin className="w-3 h-3 text-zinc-600" /> {s.city}
                                    </span>
                                ) : <span className="text-zinc-600 italic text-sm">—</span>}
                            </div>
                            <div className="col-span-1 flex items-center justify-end gap-1">
                                <button onClick={() => openEdit(s)} className="p-1.5 rounded-lg hover:bg-white/10 text-zinc-500 hover:text-white transition-colors">
            ...
            {showModal && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
                    <div className="bg-[#111113] border border-[#27272a] rounded-2xl p-8 w-full max-w-lg shadow-2xl">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            <div className="grid grid-cols-2 gap-4">
                                <div className="col-span-2">
                                    <label className="block text-xs text-zinc-400 mb-1.5 font-medium">Nombre / Razón social *</label>
                                    <input
                                ...
                                <div>
                                    <label className="block text-xs text-zinc-400 mb-1.5 font-medium">NIF / CIF</label>
                                    <input
                                ...
                                <div className="col-span-2">
                                    <label className="block text-xs text-zinc-400 mb-1.5 font-medium">Dirección</label>
                                    <input
                                ...
                                <div>
                                    <label className="block text-xs text-zinc-400 mb-1.5 font-medium">Ciudad</label>
                                    <input
                                ...
                                <div>
                                    <label className="block text-xs text-zinc-400 mb-1.5 font-medium">Código postal</label>
                                    <input
