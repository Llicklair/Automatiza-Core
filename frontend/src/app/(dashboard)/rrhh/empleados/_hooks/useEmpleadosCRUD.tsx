...
export function useEmpleadosCRUD(
    ...
    const openEdit = (emp: Employee) => {
        ...
        setForm({
            ...
            num_pagas: String(emp.num_pagas || 12),
            prorratear_pagas: emp.prorratear_pagas ?? false,
            jornada_tipo: emp.jornada_tipo || "completa",
            jornada_horas_semana: emp.jornada_horas_semana ? String(emp.jornada_horas_semana) : "",
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const payload = {
                ...
                status: form.status,
                num_pagas: form.num_pagas ? parseInt(form.num_pagas, 10) : undefined,
                prorratear_pagas: form.prorratear_pagas,
                jornada_tipo: form.jornada_tipo || undefined,
                jornada_horas_semana: form.jornada_tipo === "parcial" && form.jornada_horas_semana
                    ? parseFloat(form.jornada_horas_semana) : null,
