        ...
        <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-4" onClick={onClose}>
            <div className="w-full max-w-md rounded-2xl border border-border bg-card overflow-hidden" onClick={e => e.stopPropagation()}>
                ...
                <form onSubmit={onSubmit} className="p-6 space-y-4">
                    <div>
                        <label className="text-sm text-muted-foreground block mb-1.5 font-medium">Titulo *</label>
                    ...
                    <div>
                        <label className="text-sm text-muted-foreground block mb-1.5">Descripcion</label>
                    ...
                    <div>
                        <label className="text-sm text-muted-foreground block mb-1.5">Fecha limite (opcional)</label>
                    ...
                    <div className="flex gap-3 pt-4">
                        ...
                        <button type="submit" disabled={saving || !title.trim()}
                            ...
                            {saving ? <Loader2 className="w-4 h-4 animate-spin" /> : "Anadir al Tablero"}
                        </button>
                    </div>
                </form>
            </div>
