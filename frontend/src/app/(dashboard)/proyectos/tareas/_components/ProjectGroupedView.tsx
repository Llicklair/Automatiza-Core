...
/** Vista "por proyecto" de las tareas (antes /proyectos/mis-tareas, fusionada aquí). */
export function ProjectGroupedView() {
    ...
    return (
        <div className="flex flex-col h-[calc(100vh-6rem)] p-8 max-w-[1600px] mx-auto overflow-hidden animate-in fade-in duration-500">
