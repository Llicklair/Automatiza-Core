        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-200">
            <div className="bg-card border border-border rounded-2xl w-full max-w-md shadow-2xl overflow-hidden">
                <div className="flex items-center justify-between px-6 py-4 border-b border-border">
                    <h3 className="text-lg font-semibold text-foreground">{t("createModal.title")}</h3>
                ...
                <form onSubmit={onSubmit} className="p-6 space-y-4">
                    <div>
                        <label className="block text-sm text-muted-foreground mb-1">{t("createModal.nameLabel")}</label>
                    ...
                    <div>
                        <label className="block text-sm text-muted-foreground mb-1">{t("createModal.budgetLabel")}</label>
                    ...
                    <div>
                        <label className="block text-sm text-muted-foreground mb-1">{t("createModal.descriptionLabel")}</label>
                    ...
                    <div className="flex justify-end gap-3 pt-2 border-t border-border">
                        ...
                        <button type="submit" className="px-4 py-2 bg-primary hover:bg-primary text-foreground rounded-xl">{t("createModal.submit")}</button>
                    </div>
                </form>
            </div>
        </div>
