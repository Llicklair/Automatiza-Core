        ...
        <div className="bg-card border border-border rounded-2xl overflow-hidden">
            ...
            <div className="px-5 py-4 border-b border-border bg-card">
                <div className="flex items-center justify-between">
                    <h2 className="text-sm font-semibold text-foreground flex items-center gap-2">
                        <Mail className="w-4 h-4 text-primary" /> {t("integrations.title")}
                    </h2>
            ...
            {!anyConnected ? (
                <div className="p-8 text-center flex flex-col items-center gap-2">
                    ...
                    <p className="text-xs text-muted-foreground">{t("integrations.noneConnected")}</p>
                    <Link href="/integraciones" className="mt-2 text-xs text-primary hover:text-primary transition-colors">
                        {t("integrations.connect")} &rarr;
                    </Link>
                </div>
                ...
                <div className="divide-y divide-border max-h-[300px] overflow-y-auto">
                    {(() => {
                        ...
                        if (msgs.length === 0) return <div className="p-6 text-center text-muted-foreground text-xs">{t("integrations.noEmails")}</div>;
                        return msgs.map(msg => (
                ...
                <div className="divide-y divide-border max-h-[300px] overflow-y-auto">
                    {(() => {
                        ...
                        if (files.length === 0) return <div className="p-6 text-center text-muted-foreground text-xs">{t("integrations.noFiles")}</div>;
